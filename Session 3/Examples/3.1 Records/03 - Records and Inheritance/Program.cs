Album album1 = new("Depeche Mode", "Violator", new DateTime(1990, 03, 19));
Album album2 = new("Depeche Mode", "Violator", new DateTime(1990, 03, 19));
Console.WriteLine(album1);

Single single1 = new("Depeche Mode", "Enjoy the Silence", new DateTime(1990, 1, 1), album1);
Single single2 = new("Depeche Mode", "Enjoy the Silence", new DateTime(1990, 1, 1), album2);
